...
class RayRenderer {
    ...
    fun initGL() {
        ...
        rayVao = GLES30.glGenVertexArrays()
        GLES30.glBindVertexArray(rayVao)
        rayVbo = GLES30.glGenBuffers()
        // interleaved: pos(3) + t(1)
        GLES30.glBindBuffer(GLES20.GL_ARRAY_BUFFER, rayVbo)
        ...
        cursorVao = GLES30.glGenVertexArrays()
        GLES30.glBindVertexArray(cursorVao)
        cursorVbo = GLES30.glGenBuffers()
        GLES30.glBindBuffer(GLES20.GL_ARRAY_BUFFER, cursorVbo)
